...
class Data_Loader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     print('The number of categories is greater than 2:', np.unique(mask))
        #     print('*'*5,'Please check the data','*'*5)
        #     # exit()
...
if __name__ == "__main__":
    train_dataset = Data_Loader("datasets/Myops2020/", image_size=256, prompt_point=True, prompt_box=True)
